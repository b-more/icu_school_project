    ...
    public static function sendMessage($message_string, $phone_number)
    {
        try {
            ...
            $sendSenderSMS = Http::withoutVerifying()
                ->post('https://www.cloudservicezm.com/smsservice/httpapi?username=Blessmore&password=Blessmore&msg=' . $url_encoded_message . '&shortcode=2343&sender_id=AntifraudHQ&phone=' . $phone_number . '&api_key=121231313213123123');
